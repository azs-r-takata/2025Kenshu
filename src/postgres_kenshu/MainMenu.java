	...
	public static void main(String[] args) {
		...
		do {
			...
			try{
				...
				postgresSystem.scanner.nextLine();
				switch(menu) {
				case 1:
					System.out.println(">> メニュー「1」を選択");
					postgresSystem.showDB(); //会員一覧表示メソッド
					break;
				case 2:
					System.out.println(">> メニュー「2」を選択");
					postgresSystem.addDB(); //会員新規登録メソッド
					break;
				case 3:
					System.out.println(">> メニュー「3」を選択");
					postgresSystem.updateDB(); //会員情報更新メソッド
					break;
				case 4:
					System.out.println(">> メニュー「4」を選択");
					postgresSystem.deleteDB(); //会員削除メソッド
					break;
				case 5:
					System.out.println(">> メニュー「5」を選択");
					postgresSystem.searchDB(); //会員ID検索メソッド
					break;
				case 0:
					System.out.println(">> メニュー「0」を選択");
					end = postgresSystem.endDB(); //終了メソッド
					break;
				default:
